...
namespace MaxicoNarcos
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //result = 3 * TableValue;
            //Console.WriteLine("{0} x {1} = {2}", TableValue, 3, result);

            //result = 4 * TableValue;
            //Console.WriteLine("{0} x {1} = {2}", TableValue, 4, result);

            //result = 5 * TableValue;
            //Console.WriteLine("{0} x {1} = {2}", TableValue, 5, result);

            //result = 6 * TableValue;
            //Console.WriteLine("{0} x {1} = {2}", TableValue, 6, result);

            //result = 7 * TableValue;
            //Console.WriteLine("{0} x {1} = {2}", TableValue, 7, result);

            //result = 8 * TableValue;
            //Console.WriteLine("{0} x {1} = {2}", TableValue, 8, result);

            //result = 9 * TableValue;
            //Console.WriteLine("{0} x {1} = {2}", TableValue, 9, result);
